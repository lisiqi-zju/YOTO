...
class TDODDataset(BatchShapePolicyDataset, CocoDataset):
    ...
    def parse_data_info(self, raw_data_info: dict) -> Union[dict, List[dict]]:
        ...
        for i, ann in enumerate(ann_info):
            ...
            instance['bbox_coco_label']=ann['COCO_category_id']
...
@DATASETS.register_module()
class YTModalDataset:
    """Multi-modal dataset."""

    def __init__(self,
                 dataset: Union[BaseDataset, dict],
                 class_text_path: str = None,
                 coco_text_path: str = None,
                 test_mode: bool = True,
        ...
        if coco_text_path is not None:
            self.coco_class_texts=json.load(open(coco_text_path,'r'))
        else:
            self.coco_class_texts = None
    ...
    def get_data_info(self, idx: int) -> dict:
        ...
        if self.coco_class_texts is not None:
            data_info.update({'coco_texts': self.coco_class_texts})
        return data_info
