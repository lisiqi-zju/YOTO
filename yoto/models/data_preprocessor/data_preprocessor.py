...
class YOTODataPreprocessor(DetDataPreprocessor):
    ...
    def forward(self, data: dict, training: bool = False) -> dict:
        ...
        # data_samples['coco_bboxes_labels']=[sublist[0] for sublist in data_samples['coco_bboxes_labels']]  

        data_samples_output = {
            'bboxes_labels': data_samples['bboxes_labels'],
            'texts': data_samples['texts'],
            'coco_texts': data_samples['coco_texts'],
            'img_metas': img_metas,
            'coco_bboxes_labels': data_samples['coco_bboxes_labels']
        }
